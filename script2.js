...
form.addEventListener('submit', function(event) {
  ...
  for (var i = 1; i <= totalIntrebari; i++) {
    ...
    var raspunsCorect = 'ja'; // Răspunsul corect este "da" pentru fiecare întrebare
  ...
  rezultatContainer.innerHTML = 'Antworten für den charismatischen Leader ' + raspunsuriCorecte + ' Fragen. Der Prozentsatz beträgt: ' + procentajCorecte.toFixed(2) + '%';
});
